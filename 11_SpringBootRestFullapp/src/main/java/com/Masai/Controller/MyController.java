...
public class MyController {
	...
	@GetMapping("/students")
	public Student getStudent(@RequestParam("roll")Integer StudentRoll,@RequestParam(value =  "name",required = false)String name) {
		
	
		
		Student student=new Student(StudentRoll, name,5678);
